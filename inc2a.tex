...
\node[below left] at (0.20,-0.3) {$O_2$};
\node[below left] at (0.45,-0.03) {$\Gamma_2$};
\draw[->] (0.05,-0.25) -- (0.45,-0.25) node[below] {$x_2$};
\draw[->] (0.25,-0.45) -- (0.25,-0.05) node[left] {$y_2$};
