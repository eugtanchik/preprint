...
\draw[->,very thick] (3.4,4.15692) -- (6.5,4.15692) node[below] {$x_j$};
\draw[->,very thick] (4.8,2.8) -- (4.8,5.8) node[left] {$y_j$};
...
\fill[pattern=custom north west lines,hatchspread=10pt,hatchthickness=0.5pt,hatchcolor=black] (O8) circle(1);
