...
\coordinate (O2) at (2.0,2.0);
\coordinate (O3) at (4.0,0);
\coordinate (O4) at (6.0,2.0);

\draw[->] (-1.25,0) -- (7.0,0) node[below left] {$x$};
...
\draw (5.25,2.0) -- (6.75,2.0);
\draw (6.0,1.25) -- (6.0,2.75);
\draw (O3) -- (O4);
\filldraw[pattern=custom north west lines,hatchspread=4pt,hatchthickness=0.2pt,hatchcolor=black]
(0,0) -- (0.5,0) arc (0:45:0.5);
\filldraw[pattern=custom north west lines,hatchspread=4pt,hatchthickness=0.2pt,hatchcolor=black]
(6.0,2.0) -- (5.5,2.0) arc (180:225:0.5);
\filldraw[pattern=custom north west lines,hatchspread=4pt,hatchthickness=0.2pt,hatchcolor=black]
(4.0,0) -- (3.5,0) arc (180:45:0.5);
\filldraw[pattern=custom north west lines,hatchspread=4pt,hatchthickness=0.2pt,hatchcolor=black]
(2.0,2.0) -- (2.5,2.0) arc (360:225:0.5);
