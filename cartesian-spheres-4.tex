...
\node[above right] at (1.2,0) {$A$};
\node[above left] at (2.8,0) {$B$};

%  \node[above] at (1.25,1) {$r_{12}$};
...
%  \node[right] at (0,1) {$\theta_{12}$};
  ...
  \draw[very thick] (4.0,0) circle (1.2);
  \draw (4.0,0) ellipse (1.2 and .6);

  \draw[very thick] (2.,2) circle (1.2);
  \draw (2.,2) ellipse (1.2 and .6);

  \draw[very thick] (6.,2) circle (1.2);
  \draw (6.,2) ellipse (1.2 and .6);
...
%  \draw[dashed] (0,0) -- (2.5,-2.5);
  ...
  \node[circle, fill=black, inner sep=1pt] at (2.8,0) {};
